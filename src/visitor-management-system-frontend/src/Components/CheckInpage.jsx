  ...
  return (
    <div className="bg-black min-h-screen text-white">
      ...
      <div className="container mx-auto p-6">
        <h1 className="text-4xl font-bold mb-6 text-orange-500">Check-In</h1>
        {userData ? (
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl mb-4">Welcome, {userData.fullName}!</h2>
            ...
            <p className="text-lg">You have successfully checked in!</p>
          </div>
        ) : (
          <p className="text-lg">No user data found. Please register first.</p>
        )}
        <button
          onClick={handleBack}
